return function(Components)
    ...
    Instance.__pairs = function(self)
        return next, Components.GetComponents(self), nil
    end
    ...
    function Instance.__tostring(self)
        if self.IsNull then
            return "Dead entity: " .. debug.getaddress(self) .. " id: " .. self.Id
        end
    ...
    function Instance.__concat(a, b)
